const data = {
  ...
  a1l2: {
    ...
    content3:
      "Guan Xiao’s artistic language combines the internet together with images appropriated from art history. She is interested in the growing hyper-interconnectedness of society. Din Din Jaarh focuses on physical transformation. An onomatopoeia, 'Din Din' refers to the sound we hear when we ring a bell, run an alarm clock; it also relates us to trumpet horn and trains. As the artist once stated, 'Every part of it makes me feel they are ready to move. It's alive. It's so eager to go.'",
    content4:
  ...
  a2l2: {
    ...
    content2:
      "龚剑生于1978年，毕业自湖北美术学院油画系。虽以风景画最为人所熟知，他还创作传统绘画以及概念装置。作为中国这一代艺术家中的相当才华横溢的一位，他不间断地对绘画历史进行探究。",
    content4:
      "Chinese artist born in 1978 who graduated from the Hubei Institute of Fine Arts. Best known for landscape paintings, his also creats traditional paintings as well as conceptual installations. As a talented artist from his generation of Chinese artists, he continuously puts his continuous exploration into the research of the history of painting.",
  },
  a3l2: {
  ...
  a4l2: {
    ...
    content4:
      "American artist born in 1978 who currently lives in Paris. His work foregrounds the interpaly of mixed messages and semiotics, often disrupting the boundaries between the frame and the image. He works with hybridized techniques combining photography, painting, and drawing.",
  },
  a5l2: {

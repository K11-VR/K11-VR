...
const data = {
  a1b1: {
    ...
    p4: "布面丙烯",
    p5: "165 × 220 厘米",
    p6: "Portrait for a Tree No.5",
    p7: "Gong Jian",
    p8: "2015",
    p9: "Acrylic on canvas",
    p10: "165 × 220 cm",
    content:
      "在龚剑不断探索研究历史绘画的过程中，真实性的概念在他的艺术轨迹中扮演着重要的角色。深受风景画的影响，他相信不以人为中心的画，反而是对人类最好的社会批判。《为一棵树所作的肖像No.5》风景如画，是对一个户外公园的完美想象。艺术家描绘的是自身心中的理想大地，而画中的水光山色，在他对未来的愿景中，显得如此的真实。",
    content2:
      "龚剑生于1978年，毕业自湖北美术学院油画系。虽以风景画最为人所熟知，他还创作传统绘画以及概念装置。作为中国这一代艺术家中相当才华横溢的一位，他不间断地对绘画历史进行探究。",
    content3:
      "Gong Jian's practice highlights the discourses of depth and authencity, examining the relationship between style and content. Portrait for a Tree No.5 is a depiction of outdoor parks, almost like his ideal projection of reality. Representing a public space that can never be truly available to any meaningful public, such parks have become repositories for private scenes and desires. This space constitutes as an interface between private desires and public lives, carrying a set of social and emotional connotations explored by the artist. ",
    content4:     
      "Chinese artist born in 1978 who graduated from the Hubei Institute of Fine Arts. Best known for landscape paintings, his also creats traditional paintings as well as conceptual installations. As a talented artist from his generation of Chinese artists, he continuously explores into the research of the history of painting.",
  },
  a1l1: {
    ...
    content:
      "尉洪磊与大多数中国艺术家的不同之处，在于其雕塑作品不以社会或政治评论为主，取而代之的是无厘头般的荒谬和戏仿。《姐妹下山》描绘了一只仅有脚和翅膀的鸟，失去了身体其他部分，整体的视觉效果既有趣又奇怪。他被定义为一个“后互联网”时代下的艺术家，在这波未来创作思潮中，艺术家可以适当地从在线材料中“挪用”并获取资源。",
    content2:
      "内蒙古艺术家尉洪磊生于1984年，现生活于北京。尉洪磊的作品时常引用当代艺术和音乐典故，在创作过程中自然转变，隐喻中国城市中无序发展的视觉文化。尉洪磊认为语言文字和具体事物之间不一定要产生关联，能使作品的视觉形式与名字之间保持开放关系，带来无限的诠释空间。 ",
    content3:
      "Unlike most Chinese artists, Yu Honglei's sculptural works are absent of socio-political commentaries, instead embraces absurdity and parody. Sisters Down the Mountain depicts an parody of a bird with feet and wings, but missing the rest of the body. The overall effect is funny and strange at the same time. He has been defined as a “Post-Internet” artist which is part of a future wave of creative expression where artists appropriate and source from online materials.",
    content4:
  ...
  a2l1: {
    ...
    content:
      "吊灯的形式、美感和理念在塞里斯．怀恩．埃文斯的艺术实践中占有相当特殊的地位，作为既是通信又可传输的一种载体。这一系列吊灯雕塑以其诗意和精致的美学形式广受赞誉，致力于将物质的象征性转化为现代版的传送器。《礼物》的主体由一个传统吊灯组成，此吊灯出自知名穆拉诺玻璃工艺大师Galliano Ferro之手。透过精细的计算机程序，吊灯中的灯光以莫尔斯电码的独特排列顺序闪烁，以此传达信息。此作既代表是光的来源，又是对光的评论，同时亦创造了一种挑战观众交流、感知和现实观念的环境。",
    content2:
      "英国艺术家塞里斯．怀恩．埃文斯于1958年生于威尔士拉内利，他深具观念性的创作，探索着如何透过装置、雕塑、摄影、电影和文字等多样媒材的形式传达不同想法与思维模式。怀恩．埃文斯最初以短片和实验性电影制作人的身份开始艺术家生涯，随后在90年代转向全心发展视觉和观念艺术。他曾在多个艺术机构举办个展，包括2004年巴黎蓬皮杜艺术中心、2006年巴黎现代艺术博物馆、2014年伦敦蛇形画廊，以及2018年伦敦泰特不列颠美术馆。其作品也被伦敦泰特美术馆、纽约现代艺术博物馆与巴黎蓬皮杜艺术中心等机构收藏。",
    content3:
  ...
  a4l1: {
    ...
    content:
      "《从平渊里4号到天桥北里4号》是一个日记形式的录像作品，探索艺术家内心与自我、父母和社会压力的种种冲突。影片很大部分在强调她和母亲的关系，当提到母亲时，艺术家的叙述明显变得混乱，尾声时将口中已沾满血的刀片取出。这段视频既是一个心理画面，亦是一个表演文件。作品以“独生子女”为题，讨论了她在作为女儿和艺术家的社会约束下，必须时刻追求完美的心理压力。",
    content2:
  ...
  a6l1: {
    ...
    p10: "200 × 100 × 100 cm",
    content:
      "张鼎的艺术语言以“未来”为蓝本、灵感。《旋转立方体》是一件极为简约的雕塑，两个立方体在连续旋转中循环，可被视为动态雕塑观念的一部份。将动能带入艺术，且深受对抗过程与张力的启迪。透过建构充满反差的荒诞场景，艺术家主要以感官、感知和人的意志为中心，用社会范例来展示并解读隐含的寓意。",
    content2:
      "观念艺术家张鼎生于1980年，现生活于上海。他的艺术实践主要以个人项目的方式呈现，包括录像、装置、绘画和现场表演，等等。作品围绕着感官与意志的强度，构建了一个个荒诞而充满对抗性的场景，而这些场景常常又能够构成一种深层的社会隐喻。",
    content3:
      "Zhang Ding is an artist inspired by the future. Spinning Cube is a minimalistic sculpture with two cubes rotating in a continuous cycle. The artwork is part of the Kinetic Art genre that introduces movement into artworks, inspired by tension and confrontation. Constructing absurd scenes full of contrasts, the artist demonstrates and interprets metaphors with societal references by focusing mainly on sensory perception and human will. ",
    content4:
  ...
  a8l1: {
    image: "sources/a8l1.jpg",
    mp3: "audio/zh/a8l1.mp3",
    mp3_en: "audio/en/a8l1.mp3",
    p1: "李明",
    title: "《运动》",
    p3: "2014",
    p4: "八频数码录像,彩色有声",
    p5: "录像1：2分30秒 / 录像2：2分30秒 / 录像3：2分30秒 / 录像4：2分30秒 / 录像5：3分53秒 / 录像6：3分53秒 /录像7：3分53秒 / 录像8：3分53秒,共5版，第5版",
    p6: "Li Ming",
    p7: "Movements",
    p8: "2014",
    ...
    content2:
      "多媒体艺术家李明生于1981年，毕业自中国美术学院。他的影像装置以声音和表演的元素探索多重社会和历史背景，从一个单词或一种心境中得到启发并予以回应。他的叙事庆祝美丽的平凡，同时给予时间和空间无限的意义。",
    content3:
      "Chinese multimedia artist born in 1981 who graduated from the China Academy of Art. Inspired by a single word, image, or even a mood, he probes social and historical context through video and performance. His narrative celebrates beautiful ordinariness whilst making time and space profuse with infinite possibilities of meaning.",
    content4:
      "Li Ming sees the physical movement forward as a metaphor for the future. Movements feature a man always on the move as he changes his means of transport. This video piece can be seen as Li Ming’s subconscious. Moving forward implies positive acceleration to a greater outcome, and Movements somewhat projects an ominous digital tracking technology, showcasing the pervasive and restrictive nature of politics in Chinese daily life. ",
  },
  a1l2: {
    ...
    content3:
      "The notion of authenticity plays an important role in Gong Jian's artistic trajectory as he continues to explore into the research of history painting. Swan No. 4 is a picturesque and imagined depiction of outdoor parks. The artist is painting his ideal place, and by creating beautiful scenic places within the paintings, he is manifesting his own future where such parks  are a reality.",
    content4:
  ...
  a2l2: {
    ...
    p10: "220 × 165 cm",
    content:
      "在龚剑不断探索研究历史绘画的过程中，真实性的概念在他的艺术轨迹中扮演着重要的角色。《天鹅No.4》风景如画，是对一个户外公园的完美想象。艺术家描绘的是自身心中的理想大地，而画中的水光山色，在他对未来的愿景中，显得如此的真实。",
    content2:
      "龚剑生于1978年，毕业自湖北美术学院油画系。虽以风景画最为人所熟知，他还创作传统绘画以及概念装置。作为中国这一代艺术家中的相当才华横溢的一位，他不间断地对绘画历史进行探究。",
    content3:
      "The notion of authenticity plays an important role in Gong Jian's artistic trajectory as he continues to explore into the research of history painting. Swan No. 4 is a picturesque and imagined depiction of outdoor parks. The artist is painting his ideal place, and by creating beautiful scenic places within the paintings, he is manifesting his own future where such parks  are a reality.",
    content4:
      "Chinese artist born in 1978 who graduated from the Hubei Institute of Fine Arts. Best known for landscape paintings, his also creates traditional paintings as well as conceptual installations. As a talented artist from his generation of Chinese artists, he continuously explores into the research of the history of painting.",
  },
  a3l2: {
  ...
  a4l2: {
    ...
    content4:
      "American artist born in 1978 who currently lives in Paris. His work foregrounds the inter paly of mixed messages and semiotics, often disrupting the boundaries between the frame and the image. He works with hybridized techniques combining photography, painting, and drawing.",
  },
  a5l2: {
    ...
    p10: "155 × 155 cm",
    content:
      "《4102》完美展示尚一心新的艺术方向，将其艺术哲思转向光源和几何形状的应用。在制作雕塑的短暂过程中，当移动的光线投射在物体上，产生流动的抽象阴影，呈现黑暗和明亮表面间深刻的视觉关联。他在方形模板上喷上层层的油漆，以创造出强烈的图样，而几何形状中的十字形图案，则带给观者一种从平面到立体的视觉感受。",
    content2:
      "尚一心出生于1980年，毕业自中国美术学院油画系。他的创作包含绘画与装置，并持续探索抽象语汇与概念艺术。通过不断的实践，尚一心讨论观看与被观看、个体与群体、逻辑与认知之间的关系。",
    content3:
  ...
  a6l2: {
    ...
    content3:
      "Zhou Siwei questions the potential and plasticity behind the act of looking. Vase (Xi Shuang Ban Na) presents two vase which are doppelgänger of each other- one is the past self, while the other is the future self. The presence of the sun in the work highlights the underlining positive emotions that color the paintings. ",
    content4:
      "Chinese artist born in 1981 who graduated from the Sihuan Fine Arts Institute. By employing recurring patterns in his paintings and re-engineering structures in his mixed-media installations, he has created a visual logic that challenges the usual ways of seeing.",
  },
  a7l2: {
    image: "sources/a7l2.jpg",
    mp3: "audio/zh/a7l2.mp3",
    mp3_en: "audio/en/a7l2.mp3",
    p1: "关小",
    title: "《David》 ",
    p3: "2013",
    p4: "单频高清数码录像,彩色有声",
    ...
    p7: "David",
    p8: "2013",
    p9: "Single HD Video,Color sound",
    p10: "5',Edition 5 of 5",
    content:
      "关小的艺术语言将网络与艺术史上的图像结合在一起，她亦对社会间各样日益紧密的联系产生兴趣。《David》在一系列电影小插曲中向这座指标性的雕像致敬，强调了观众在科技主导之社会中的重要作用，因为通过仔细观察，我们才可以充分欣赏、理解眼前所见的一切事物。她的创作过程一向尊重数位科技，以及其把人们聚在一起的能力。",
    content2:
      "多媒体艺术家关小生于1983年，毕业自中国传媒大学。她视创作为评述影像的方式，其录像、装置艺术及雕塑作品关注新科技带来的影像流通方式如何改变事物之间的关系，鼓励观者重新看待新与旧，自我与他者，甚至动物与非生物的关系。",
    content3:
      "Guan Xiao’s artistic language combines the internet together with images appropriated from art history. She is interested in the growing hyper-interconnectedness of society. David pays homage to the iconic statue in series of cinematic vignettes. It emphasizes the important role of the viewer in a tech dominated society, because it is by observing the environment can we fully appreciate what we see. Guan Xiao’s artworks pay respect to digital technology and its ability to bring people together.",
    content4:
      "Chinese multimedia artist born in 1983 who graduated from the Communication University of China. Working mainly in sculpture, installation and video, she explores how ways of seeing are now influenced by digital image circulation as an increasingly dominant source of knowledge and information exchange.  Her work aims to expand the aesthetic and cognitive possibilities for how identity and meaning are assigned and understood.",
  },
  a1l3: {
    ...
    p10: "100 × 80 cm",
    content:
      "此幅画作属于《很有想法的绘画》系列的一部分，它视抽象绘画为讨论核心，尝试解决创作意图背后的基本问题。赵要的灵感源自于几何结构，利用色块、纹理和图案的交相辉映来展示工业产品之系统性。《很有想法的绘画 III-101》质疑知识建构、公认的社会接受准则等课题，提出了一种观者对潜意识现实的接受与认识，最终实现自我内在的绝对独立。",
    content2:
      "观念艺术家赵要生于1981年，目前定居于北京。作为一群在中国重新定义当代艺术的艺术家其中一员，其创作涵盖了装置、绘画、录像及摄影等多种媒材。",
    content3:
      "This painting is part of the “A Painting of Thought” series. It addresses the fundamental questions behind the intention of making artworks, notably abstract paintings. Zhao is inspired by geometrical structures; he uses textures and patterns incorporated into colour blocks to demonstrate the systematization in industrial products. Current work questions ideas of knowledge construction and accepted social codes of understanding, proposing an awareness of our subconscious acceptance of reality to achieve autonomy within ourselves.",
    content4:
  ...
  a2l3: {
    ...
    p4: "木本塑胶彩及布料拼贴",
    p5: "300 × 200 厘米",
    p6: "Alexander Tovborg",
    p7: "The Marriage of Heaven and Hell (Lucifer)",
    p8: "2016",
    p9: "Acrylic and fabric collage on wood",
    p10: "300 × 200 cm",
    content:
      "亚历山大·托夫堡借鉴过去发生的故事，以探索和给予古典原型一个全新的语境。他进一步探讨了人类如何想象自己以及在所居住的已知和未知的世界中，宗教可能会扮演的中心角色。作为其美学实践的完美体现，观看《天国与地狱的联姻（路西法）》 的构图，如同经历一场大胆、乐观、色彩丰富的未来预言。",
    content2:
      "丹麦艺术家亚历山大·托夫堡生于1983年，毕业自丹麦皇家建筑艺术学院。他的艺术创作深受宗教艺术、神话及玄学的启发，以及口述及文本记载，探索古典原型及将其重新定位。通过审视既定的叙述，他提出当前社会和政治形势的新解读。",
    content3:
      "Alexander Tovborg draws on the stories that have come before us in order to explore and re-contextualise classical archetypes. He further explores the central role that religion might play in how our species imagines itself, and the seen and unseen worlds it inhabits.  The Marriage of Heaven and Hell (Lucifer) perfectly exemplifies the aesthetics of his artistic practice. Looking at the compositions is like experiencing a prophetic vision of a future that is bold, optimistic, and richly hued.",
    content4:
      "Danish painter born in 1983 who graduated from the Royal Academy of Fine Arts in Denmark. Taking his starting point in history, mythology, religion, as well as written and oral narratives, he explores and re-contextualizes classical archetypes. By reexamining established narratives, he proposes a new reading of our current social and political situation.",
  },
  a3l3: {
    ...
    content2:
      "香港艺术家郑婷婷生于1990年，毕业自香港浸会大学，主要从事绘画及素描创作。钟情于日常风景独特气质的她，作品围绕对平凡事物的观察和叙述。她亦透过组合不同材料，利用个人经历谱出一首画面上的交响曲。",
    content3:
      "Cheng Ting Ting is fascinated by the journey of childhood to adulthood. Much of her oeuvre is a visual allegory of her personal experiences. Investigation of Sands (17:00) is an excellent example of her aesthetic that combines vibrant storytelling with colorful landscapes and characters. Framing the work through the lens of childhood, it highlights the pending future and the surprises which might come with it.",
    content4:
      "Cheng Ting Ting born in 1990, currently lives in Hong Kong graduated in BA from Academy Visual Arts, Hong Kong Baptist University, specializing in painting and drawing. Cheng explores her personal memory through a wandering perspective, her artwork provides a narrative sense and foreignness, capturing the random occurrences in daily life.",
  },
  a4l3: {
    ...
    content3:
      "Jules De Balincourt’s Vision Quest refers to Native American culture where young boys experience visions of their guardian spirits who will protect them for the rest of their lives. Evoking notions of dystopia, he paints landscapes during the night with distorted figures to create a scene of eeriness and imbalance. Filtered through the artist's own psychological landscape, his work is a confluence of reality and fantasy.",
    content4:
      "French-American painter born in 1972 who currently lives in New York. His most well known works touch on the topic of an 'outsider' (the Paris-born artist has been living in the United States since childhood), foregrounding vibrant colors in both abstract and figurative compositions.",
  },
  a5l3: {
  ...
  a1l4: {
    ...
    p10: "Canvas: 59 × 54.9 cm",
    content:
      "观念艺术家洛朗‧格拉索着迷于科学、神话、历史和种种超自然现象。《研究过往》描绘一个文艺复兴时期的场景，再缀以带有未来主义的图样。超自然主题曾经是十八世纪科学家们最喜欢的学科，在维多利亚时代更经常被当作客厅娱乐的话题。艺术家重新再现这些景象，以建立一种时间与空间的超现实并置。",
    content2:
      "法国观念艺术家洛朗‧格拉索生于1972年，他的创作包含视频，雕塑，绘画和档案摄影。格拉索探索穿梭于现代世界的机械与系统，并糅合艺术、技术、哲学与电影历史创造出非同寻常的视野。圆形的解构跟随科学与自然现象中关联，其概念成为他艺术绘画中重要的题材。",
    content3:
      "Laurent Grasso is inspired by science, mythology, history, and the supernatural. Studies into the Past shows a Renaissance scenes appropriated with futuristic motifs. The subject of the supernatural was once a favourite subject of 18th Century scientists, often used as parlour entertainment during the Victorian era. Grasso recreates these phenomenon to set up surreal juxtapositions of time and space.",
    content4:
  ...
  a2l4: {
    ...
    content3:
      "Liu Weijian’s landscapes are part of this world, and yet the generous amounts of sunlight and absence of people, only underlines the futuristic element of each painting. Home is a perfect example of his painterly aesthetic. Current work marks the artist's quest into rebuilding  different memory fragments. His scenes-which often feature windows-tend to serve as a reminder that there are other worlds outside the pictorial plane.",
    content4:
      "Chinese artist born in 1981 who graduated from Shanghai Normal University of Art. He specializes in realism, notably realist landscapes and every day objects. As figure is never the centre of a painting, he further highlights the stark details and mood of each place depicted.",
  },
  a3l4: {
  ...
  a1l5: {
    ...
    content3:
      "Osang Gwon is critically acclaimed for his innovative use of photography and pragmatic consideration of the sculptural medium. 2009 September is a collage of bright images, challenging the boundaries of medium specificity in the immaterial culture of digitalized efficiency. 2009 September gives off the illusion of being a three dimensional collection of random items placed together, but upon a closer look it is millions of two dimensional photos overlapping each other in one crowded scene. ",
    content4:
      "Korean conceptual artist born in 1974 who is highly respected for his collection of works that combine traditional photography with 3D sculptural works. His artistic style is distinctly unique for its focus on mass and solidity through the lighter two-dimensional medium.",
  },
  a2l5: {
  ...
  a3l5: {
    ...
    p10: "100 × 80 cm",
    content:
      "赵要属于一群迅速重新定义了中国当代艺术运动的年轻艺术家，《很有想法的绘画 I - 465》呈现一个崭新的视觉语言，一个四种色块组成的三角形堆叠在花呢织品的表面上。赵要早期的创作深受藏传佛教经幡的启发，近期逐渐转向对纺织品艺术性的探索。其艺术语汇着重于探究社会文化现实与基础结构间的关联，同时也对真实性和原创性的艺术理想提出了种种质疑。",
    content2:
